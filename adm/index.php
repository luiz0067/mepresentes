...
<style type="text/css">
	...
	#ERP{
		width:800px; height:112px; float:left; display:block; text-align:center; line-height:112px; font-family:Arial, Helvetica, sans-serif; font-style:normal; font-size:24px; color:#666;}
	...
	<div id="tudo">
        ...
        <div class="linhas">
        	<div class="linhacentro" style="height:151px;">
                ...
                <div class="espaco" style="height:151px; width:298px; background-image:url(./imagens/logo.jpg)"></div>
