...
<?php
	...
	if ($_POST) {
		...
		if ($_POST['acao']=='Inserir'){
			$sql = "insert into albuns (imagem,titulo,data_emissao,obs) values ('".$imagem."','".$_POST["titulo"]."','".$_POST["data_emissao"]."','".$_POST["obs"]."');";
		...
		$sql = "update imagem set albuns='".$imagem."',titulo='".$_POST["titulo"]."',data_emissao='".$_POST["data_emissao"]."',obs='".$_POST["obs"]."' where (id=".$_POST["id"].");";
		echo $sql;
		$reultado = mysql_query($sql, $link);
		if($sql){
				$erro = "Dados salvos com sucesso!";
